...
```json
{
  "apiDescription" : "An example service",
  "apiOwner" : "user:bglover",
  "apiSystem" : "customer",
  "artifactId" : "customer-profile",
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=billglover&repo=tanzu-wld-java-rest-app",
  "buildTool" : "maven",
  "databaseMigrationTool" : "flyway",
  "databaseName" : "customer-profile-database",
  "exposeOpenAPIEndpoint" : true,
  "groupId" : "xyz.tanzu.tap.services",
  "javaVersion" : "11",
  "liveUpdateIDESupport" : true,
  "packageName" : "xyz.tanzu.tap.services.customerprofile",
  "projectName" : "java-rest-service",
  "sourceRepositoryPrefix" : "harbor.tanzu.xyz/tap"
}
```
## Log
```
...
┃ ┃ ┃ Debug Adding symbol packageDirectory with value 'xyz/tanzu/tap/services/customerprofile'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [<groupId>com.vmware.tap.accelerators</groupId>-><groupId>xyz.tanzu.t...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#exposeOpenAPIEndpoint) evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [DESCRIPTION_VAL->An example service, OWNER_VAL->user:bglover, SYSTEM_VAL->customer]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [dev.local->harbor.tanzu.xyz/tap]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=billglover&repo=tanzu-wld-java-rest-app'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [com.vmware.tap.accelerators.restservicedb->xyz.tanzu.tap.servic...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/api/CustomerProfileController.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/xyz/tanzu/tap/services/customerprofile/api/CustomerProfileControllerTest.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/data/CustomerProfileEntity.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/postgres.yaml didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/domain/CustomerProfileResponse.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/data/CustomerProfileRepository.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/xyz/tanzu/tap/services/customerprofile/domain/CustomerProfileServiceTest.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug LICENSE didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/domain/CustomerProfileCreateRequest.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/xyz/tanzu/tap/services/customerprofile/ApplicationTests.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw.cmd didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/domain/CustomerProfileService.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/Application.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/xyz/tanzu/tap/services/customerprofile/data/CustomerProfileRepositoryTest.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/api/CustomerProfileController.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/xyz/tanzu/tap/services/customerprofile/api/CustomerProfileControllerTest.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/data/CustomerProfileEntity.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/postgres.yaml didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/domain/CustomerProfileResponse.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/data/CustomerProfileRepository.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/xyz/tanzu/tap/services/customerprofile/domain/CustomerProfileServiceTest.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug LICENSE didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/domain/CustomerProfileCreateRequest.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/xyz/tanzu/tap/services/customerprofile/ApplicationTests.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw.cmd didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/domain/CustomerProfileService.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/Application.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/xyz/tanzu/tap/services/customerprofile/data/CustomerProfileRepositoryTest.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/api/CustomerProfileController.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/test/java/xyz/tanzu/tap/services/customerprofile/api/CustomerProfileControllerTest.java didn't match [manifest.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/data/CustomerProfileEntity.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/domain/CustomerProfileResponse.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/data/CustomerProfileRepository.java didn't match [manifest.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/test/java/xyz/tanzu/tap/services/customerprofile/domain/CustomerProfileServiceTest.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/test/java/xyz/tanzu/tap/services/customerprofile/ApplicationTests.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/domain/CustomerProfileCreateRequest.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug mvnw.cmd didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/domain/CustomerProfileService.java didn't match [manifest.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/main/java/xyz/tanzu/tap/services/customerprofile/Application.java didn't match [manifest.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/test/java/xyz/tanzu/tap/services/customerprofile/data/CustomerProfileRepositoryTest.java didn't match [manifest.yaml] -> included
